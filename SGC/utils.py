...
def load_citation(dataset_str="cora", normalization="AugNormAdj", cuda=True, modified=False, attacked=False):
    """
...
def mix_sgc_precompute(features, adj, degree):
    t = perf_counter()
...
def load_reddit_data(data_path="data/", normalization="AugNormAdj", cuda=True, modified=False):
    path = '../LAGCN/'
